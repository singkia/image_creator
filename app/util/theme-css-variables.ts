/**
 * [INPUT]: 依赖 @shikijs/core 提供的能力
 * [OUTPUT]: 对外导出 CssVariablesThemeOptions、createCssVariablesTheme 等接口
 * [POS]: app/util/theme-css-variables.ts 在 app/util 中承担职责：工具模块中的纯函数单元，被上层组件与路由复用
