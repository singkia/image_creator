...
export const paddingAtom = atomWithStorage<string>("padding", "64");
export const showBackgroundAtom = atomWithStorage<boolean>("showBackground", true);
export const visibleThemeAtom = atom((get) => get(themeAtom));
