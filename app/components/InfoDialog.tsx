/**
 * [INPUT]: 依赖 @/components/button、@/components/dialog、@/components/kbd、@/components/social-footer 提供的能力
 * [OUTPUT]: 对外导出 InfoDialog 等接口
 * [POS]: app/components/InfoDialog.tsx 在 app/components 中承担职责：UI 渲染层组件，组合状态与视图输出
